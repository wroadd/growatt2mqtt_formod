...
class growattIF {
  ...
  private:
    ...
    {
      int status;
      float solarpower, pv1voltage, pv1current, pv1power, pv2voltage, pv2current, pv2power, outputpower, gridfrequency, gridvoltage, ph1voltage, ph1current, ph1power, ph2voltage, ph2current, ph2power, ph3voltage, ph3current, ph3power, lineph1voltage, lineph2voltage, lineph3voltage;
